      ...
      <el-card shadow="always" class = "fourth-card">
        <el-col :span="16" style="text-align: left;">
          <el-row >
            <el-col :span="4">
              <el-image
                style="width: 60%; height: 60%; padding-left: 35%; padding-top: 15%"
                :src="require('@/assets/trip.png')">
              </el-image>
            </el-col>
            <el-col :span="20" style="padding-top: 3%; padding-left: 5px; font-weight: bold;">
...
<!--          </span>-->
      ...
      <el-image
        style="width: 94%; height: 94%; margin-top: 5px"
